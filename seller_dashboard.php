	...
	<div class="row">
		...
		<div class="col-sm-3">
			<ul class="nav navbar-nav listy">
				<li><a href="seller_productlist.php"><i class="fa fa-list" aria-hidden="true"></i>&nbsp; Product list</a></li>
			</ul>
		</div>
		<div class="col-sm-3">
			<ul class="nav navbar-nav listy">
				<li><a href="seller_product.php"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp; Add Product</a></li>
			</ul>
		</div>
		<div class="col-sm-3">
			<ul class="nav navbar-nav listy">
				<li><a href="seller_oderlist.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp; Orderlist</a></li>
			</ul>
		</div>
	</div>
	<div class="container">
