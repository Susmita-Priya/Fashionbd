		...
		<div class="col-md-8 clearfix">
			<div class="shop-menu clearfix pull-right">
				<ul class="nav navbar-nav">
								<li><a href="admin_del_status.php"><i class="fa fa-book" aria-hidden="true"></i> Approval</a></li>
							</ul>
			</div>
		</div>
	</div>
				...
				<div class="col-md-5 offset-md-3">
					...
					<div class="card bg-dark pos">
						<div class="card-header">
							<h2 class="text-danger text-center">APPROVE DELIVERY STATUS</h2>
						</div>
						<hr>
						<div class="card-body">
							...
							<form action="#" method="POST">
								...
								<div class="form-group text-light font-weight-bold">
									<label for="product">Delivery Status </label>
									<input type="text" name="app" id="app" class="form-control form-control-lg" required="" value="<?php echo $delivery;?>"  >
								...
								<div class="card-footer text-center">
									<div class="form-group">
										<button type="submit" name="submit" class="btn btn-success mx-3 my-2">Approve</button>
									</div>
								</form>
							</div>
						</div>
...
if($iquery){
	$insquery = "DELETE FROM delivery WHERE orderid=$id";
	$iquery =mysqli_query($con, $insquery);
?>
<script>
	alert("Delivery Status Report has been approved");
	location.replace("admin_del_status.php");
</script>
<?php
}else{
?>
<script>
	alert("Delivery Status Report has not been approved");
</script>
<?php
}
}
