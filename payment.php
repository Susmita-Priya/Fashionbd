	 ...
	 <?php
         include 'insert.php';
			...
			if(isset($_POST['submit']))
			{
					...
					$del_contact='';
					$status='';
					$insertquery = "insert into payment(email,username,bank,number,transaction_id,product_id,amount,address,taken,del_name,del_id,del_email,del_contact,status) values('$email', '$name', '$bank', '$number', '$tnx', '$product', '$amount','$loc' ,'$taken','$del_name','$del-id','$del_email','$del_contact','$status')";
						...
						<div class="card-body">
							...
							<form action="#" method="POST">
								...
								<div class="form-group">
									...
									<input type="text" name="loc" id="loc" class="form-control  " value="<?php echo $_SESSION['address'];?>" >
