						...
						<div class="card-body ">
							...
							<form action="#" method="post">
								<div class="form-group">
									<label for="email">E-mail address : </label><span><input type="email" name="email" id="email"  class="form-controll "value="<?php echo $_SESSION['email'];?>" ></span>
									
								</div>
								<div class="form-group">
									<label for="name">Full Name :  </label>
									<input type="text" name="username" id="name" class="form-controll" value="<?php echo $_SESSION['username'];?>" >
									
								</div>
								<div class="form-group">
									<label for="nmbr">Contact Number : </label>
									<input type="text" name="nmbr" id="nmbr" class="form-controll  "  value="<?php echo $_SESSION['nmbr'];?>" >
									
								</div>
								
								<!-- <div class="form-group">
									<label for="dob">Date of Birth : </label>
									<input type="text" name="dob" id="date" class="form-controll" value="<?php echo $_SESSION['dob'];?>" >
								</div> -->
								<div class="form-group">
									<label for="dis">Division :</label>
									<input type="text" name="division" id="division" class="form-controll"  value="<?php echo $_SESSION['district'];?>" >
								</div>
								<div class="form-group">
									<label for="address">Address : </label>
									<input type="text" name="address" id="address" class="form-controll"  value="<?php echo $_SESSION['address'];?>" >
								...
								<div class="card-footer text-center">
									<div>
										<p class="already"><span><a class="al" href="update_info.php?em=<?php echo $_SESSION['email'];?> & nm=<?php echo $_SESSION['username'];?> &cn=<?php echo $_SESSION['nmbr'];?>  & div=<?php echo $_SESSION['district'];?> & add=<?php echo $_SESSION['address'];?>">Update information ?</a></span></p>
									</div>
								</form>
							</div>
						</div>
