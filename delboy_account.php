						...
						<div class="card-body ">
							...
							<form action="#" method="post">
								<div class="form-group">
									<label for="id">Delivery boy's Id : </label>
								...
								<div class="card-footer text-center">
									<div>
										<p class="already"><span><a class="al" href="delboy_upac.php?id=<?php echo $_SESSION['idd'];?> & em=<?php echo $_SESSION['emaill'];?> & nm=<?php echo $_SESSION['namee'];?> &cn=<?php echo $_SESSION['nmbrr'];?> & add=<?php echo $_SESSION['addresss'];?>">Update information ?</a></span></p>
									</div>
								</form>
							</div>
						</div>
