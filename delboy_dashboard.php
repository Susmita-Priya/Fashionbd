		...
		<div class="col-md-8 clearfix">
			<div class="shop-menu clearfix pull-right">
				<ul class="nav navbar-nav">
					<li><a href="delboy_account.php"><i class="fa fa-user"></i> Account</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-3">
			<ul class="nav navbar-nav listy">
				<li><a href="delboy_delivery.php"><i class="fa fa-list" aria-hidden="true"></i>&nbsp Delivery Status</a></li>
			</ul>
		</div>
		<!-- <div class="col-sm-6">
			<ul class="nav navbar-nav listy">
				<li><a href="delboy_add_del.php"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp Add status</a></li>
			</ul>
		</div> -->
		<div class="col-sm-3">
			<ul class="nav navbar-nav listy">
				<li><a href="delboy_orderlist.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp Take Order</a></li>
			</ul>
		</div>
	</div>
	<div class="container">
