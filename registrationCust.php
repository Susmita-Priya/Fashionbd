...
<html lang="en">
	...
	<body>
		...
		{
		$insertquery = "insert into logincustomer(username,nmber,email,district,address,pass,pass1,token,status) values('$username','$number','$email', '$district' ,'$address','$pass','$pass1','$token','inactive')";
