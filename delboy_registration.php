...
<html lang="en">
	...
	<body>
		...
		$emailquery =" select * from logindel where email='$email' ";
		...
		{
		$insertquery = "insert into logindel(id,email,name,contact,address,pass,con_pass) values('$id','$email','$username','$number','$address','$pass','$pass1')";
		...
		if($iquery){
			...
			location.replace("delboy_login.php");
		   </script>
		   <?php
						...
						<div class="card-body ">
							...
							<form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
								...
								<div class="card-footer text-center">
									...
									<p class="already">Already a member? <span><a class="al" href="delboy_login.php">Login here</a></span></p>
								</form>
							</div>
						</div>
					</div>
