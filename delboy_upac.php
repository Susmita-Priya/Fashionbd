...
<?php
	include ('insert.php');
		...
		$address=mysqli_real_escape_string( $con,$_POST['address']);
         ...
         $emailquery="UPDATE logindel SET id='$id',name='$username',contact='$number',address='$address' WHERE email='$email'";
         ...
         <script>
		 alert("Successful !");
		location.replace("delboy_account.php");
		</script>
		<?php
	}
        ?> 
							...
							<form action="#" method="post">
								...
								<div class="card-footer text-center">
									<div class="form-group">
										...
										<button type="back" name="back"class="btn btn-success mx-3"><a class=back href="delboy_account.php"> Back</a></button>
